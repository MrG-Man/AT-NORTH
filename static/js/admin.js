...
class AdminInterface {
    ...
    async handleDropdownChange(dropdown) {
        ...
        try {
            ...
            console.log('[ADMIN DEBUG] Starting assignment:', {
                matchId: matchId,
                selector: selector,
            ...
            console.log('[ADMIN DEBUG] Sending POST request to /api/assign:', requestBody);
            ...
            console.log('[ADMIN DEBUG] Response JSON:', result);
            ...
            if (result.success) {
                ...
                console.log('[ADMIN DEBUG] Assignment successful, refreshing page');
                ...
                console.error('[ADMIN DEBUG] Assignment failed:', result.error);
            ...
            statusSpinner.style.display = 'none';
            statusText.style.color = '#f44336';
            console.error('[ADMIN DEBUG] Assignment network error:', error);
